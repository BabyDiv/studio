...
const schedule: Record<Day, string[]> = {
  ...
  Пт: [
    ...
    '20:00 Aerial Sport — Илона',
  ],
  Сб: [
    '10:00 Aerial Sport (детская группа) — Илона',
    '11:30 Aerial Sport (детская группа) — Илона',
    '12:30 Aerial Sport (mix группа) — Илона',
    '13:30 Aerial Sport (детская группа) — Aрина',
  ],
  Вс: [
    '10:00 Aerial Sport (детская группа) — Илона',
    '11:30 Aerial Sport (детская группа) — Илона',
